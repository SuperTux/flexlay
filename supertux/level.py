...
class Level:
    ...
    @staticmethod
    def from_file(filename: str) -> 'Level':
        level = Level()
        ...
        tree: Any = load_lisp(level.filename, "supertux-level")
        data = tree[1:]
    ...
    @staticmethod
    def from_size(width: int, height: int) -> 'Level':
        result = Level()
    ...
    def __init__(self) -> None:
        ...
        self.tileset_path: str = os.path.join("images", "tiles.strf")

        self.is_worldmap: bool = False
